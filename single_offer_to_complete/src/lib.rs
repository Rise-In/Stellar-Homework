...
impl SingleOffer {
    pub fn create(
        ...
        //If one of them equals zero panic -> "zero price is not allowed"
     ...
     pub fn trade(e: Env, buyer: Address, buy_token_amount: i128, min_sell_token_amount: i128) {
        ...
        //Check is 'sell_token_amount' less than 'min_sell_token_amount'
        //If it's true then panic -> "price is too low"
